			...
			<form:form method="post" modelAttribute="request" action="${pageContext.request.contextPath}/${action}">
				<table class="table">
					...
					<tr>
						...
						<td><form:input type="text" path="description" placeholder="Describe this request" maxlength="200" />
							<form:errors path="description" cssClass="error"/>
						</td>
					</tr>
					<tr>
						<td class="register"><input type="submit" value="Add request" class="button2" onclick="return confirm('Do you want to submit your data?')"/></td>
