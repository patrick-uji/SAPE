			...
			<table class="list">
				...
				<c:forEach items="${requests}" var="request">
					<tr>
						...
						<td><a href="${pageContext.request.contextPath}/request/update/${request.id}.html" onclick="return confirm('Do you want to edit this request?')" >Edit</a>
						<td><a href="${pageContext.request.contextPath}/request/delete/${request.id}.html" onclick="return confirm('Do you want to remove this request?')" >Remove</a>
					</tr>
				</c:forEach>
			</table>
		</div>
